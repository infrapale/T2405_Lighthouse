/*
Watchdog Timer Basic Example 10 June 2011
Nicolas Larsen
*/
#include <avr/wdt.h> 
int loop_count = 0;
...
void watchdogSetup(void)
{
  ...
  WDP3 = 0 :For 2000ms Time-out WDP2 = 1 :For 2000ms Time-out WDP1 = 1 :For 2000ms Time-out WDP0 = 1 :For 2000ms Time-out
  */
  // Enter Watchdog Configuration mode: WDTCSR |= (1<<WDCE) | (1<<WDE); // Set Watchdog settings:
